...
Route::view('/','welcome');
///       Password
Route::get('/password/update',[PasswordController::class,'update'] )->name('password.update')->middleware('guest');
Route::post('/password/check',[PasswordController::class,'check'] )->name('password.check')->middleware('guest');
Route::get('/verify/{user}',[PasswordController::class,'verify'] )->name('password.verify')->middleware('guest');
Route::post('/password/store/{user}',[PasswordController::class,'store'] )->name('password.store')->middleware('guest');
///         search
